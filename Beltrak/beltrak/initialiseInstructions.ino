...
void initialiseInstructions()
{
  ...
  inst[2][0][0] = 'W';  inst[2][0][1] = '1';  inst[2][0][2] = 'D';  inst[2][0][3] = '3';
  inst[2][1][0] = 'W';  inst[2][1][1] = '5';  inst[2][1][2] = 'C';  inst[2][1][3] = '3';
  ...
  inst[3][0][0] = 'W';  inst[3][0][1] = '1';  inst[3][0][2] = 'X';  inst[3][0][3] = '1';
