...
void initialiseInstructions()
{
  ...
  inst[1][0][0] = 'W';  inst[1][0][1] = '1';  inst[1][0][2] = 'D';  inst[1][0][3] = '1';
  inst[1][1][0] = 'W';  inst[1][1][1] = '0';  inst[1][1][2] = 'S';  inst[1][1][3] = '1';
  ...
  inst[2][1][0] = 'W';  inst[2][1][1] = '0';  inst[2][1][2] = 'S';  inst[2][1][3] = '1';
  inst[2][2][0] = 'W';  inst[2][2][1] = '3';  inst[2][2][2] = 'S';  inst[2][2][3] = '2';
  inst[2][3][0] = 'B';  inst[2][3][1] = '0';  inst[2][3][2] = 'S';  inst[2][3][3] = '1';
