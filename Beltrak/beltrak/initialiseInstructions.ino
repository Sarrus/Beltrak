...
void initialiseInstructions()
{
  ...
  inst[2][5][0] = 'W';  inst[2][5][1] = '3';  inst[2][5][2] = 'S';  inst[2][5][3] = '0';
  ...
  inst[3][3][0] = 'B';  inst[3][3][1] = '8';  inst[3][3][2] = 'C';  inst[3][3][3] = '2';
  inst[3][4][0] = 'B';  inst[3][4][1] = '9';  inst[3][4][2] = 'S';  inst[3][4][3] = '3';
  inst[3][5][0] = 'W';  inst[3][5][1] = '7';  inst[3][5][2] = 'S';  inst[3][5][3] = '0';
  inst[3][6][0] = 'W';  inst[3][6][1] = '1';  inst[3][6][2] = 'X';  
  
  
//  inst[1][0][0] = 'B';  inst[1][0][1] = '1';  inst[1][0][2] = 'S';  inst[1][0][3] = '2';
//  inst[1][1][0] = 'W';  inst[1][1][1] = '2';  inst[1][1][2] = 'C';  inst[1][1][3] = '1';
//  inst[1][2][0] = 'B';  inst[1][2][1] = '2';  inst[1][2][2] = 'S';  inst[1][2][3] = '4';
//  inst[1][3][0] = 'W';  inst[1][3][1] = '2';  inst[1][3][2] = 'C';  inst[1][3][3] = '2';
//  inst[1][4][0] = 'B';  inst[1][4][1] = '5';  inst[1][4][2] = 'S';  inst[1][4][3] = '2';
//  inst[1][5][0] = 'W';  inst[1][5][1] = '2';  inst[1][5][2] = 'C';  inst[1][5][3] = '3';
//  inst[1][6][0] = 'B';  inst[1][6][1] = '2';  inst[1][6][2] = 'C';  inst[1][6][3] = '4';
//  inst[1][7][0] = 'W';  inst[1][7][1] = '5';  inst[1][7][2] = 'S';  inst[1][7][3] = '3';
//  inst[1][8][0] = 'B';  inst[1][8][1] = '3';  inst[1][8][2] = 'X';  inst[1][8][3] = '5';
//  inst[1][9][0] = 'W';  inst[1][9][1] = '5';  inst[1][9][2] = 'S';  inst[1][9][3] = '3';
//  inst[1][10][0] = 'B';  inst[1][10][1] = '3';  inst[1][10][2] = 'X';  
  
  
  
  inst[4][0][0] = 'W';  inst[4][0][1] = '1';  inst[4][0][2] = 'X';  inst[4][0][3] = '1';
  
  inst[5][0][0] = 'W';  inst[5][0][1] = '1';  inst[5][0][2] = 'X';  inst[5][0][3] = '1';
  
  inst[6][0][0] = 'W';  inst[6][0][1] = '1';  inst[6][0][2] = 'X';  inst[6][0][3] = '1';
